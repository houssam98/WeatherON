...
public class WeatherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        circleView = (CircleView) rootView.findViewById(R.id.temperature_circle);
    ...
    private void renderWeather(JSONObject json){
        try {
            ...
            circleView.setTitleText(String.format("%.2f", main.getDouble("temp"))+ " ℃");
            circleView.setTitleSize(100);
